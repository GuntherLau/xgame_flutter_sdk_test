...
#ifndef XXXSDK_SWIFT_H
#define XXXSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="xxxsdk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6xxxsdk15WKCookieWebView")
...
@interface WKCookieWebView (SWIFT_EXTENSION(xxxsdk)) <WKNavigationDelegate>
